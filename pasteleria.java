...
public class pasteleria {
    ...
    String [] menus={"TORTA TRES LECHE","TORTA SELVA NEGRA", "TORTA DE CHOCOLAYR", "TORTA DE CHOLATE Y VAINILLA"};
    ...
    public void ComprarMenu() {
        ...
        System.out.println("Ud ha pedido " + cantidad + " platos de " + nombresTortas[opcionTorta] + " (" + nombresTamanos[opcionTamano] + ")");
        ...
        switch (opcion){
            ...
            case 3:
                ...
                carrito[2]+=cantidad;
                System.out.println("Ud ha pedido "+carrito[2]+ "tortas "+menus[2]);
    ...
    public double PagoMenus(){
        System.out.println("Elija los siguientes horarios disponibles:");
                ...
                switch(opcpago){
                    case 1:
                        ...
                        if(montopagar==preciosTortas [1] ){
                            System.out.println("Ud ya compro la torta: "+menus);
                        }
                    ...
                    case 2:
                        ...
                        if(tarjeta.length()==19||tarjeta.matches("[4-5]\\d{3}\\d{4}\\d{4}\\d{4}")){
                            ...
                            if(cvv.length()==3||cvv.matches("\\d{3}")){
                                ...
                                System.out.println("Ud está torta al menus:"+menus);
                            }
                        }
                        else{
    ...
    public static void main(String [] args){
        pasteleria papanoel= new pasteleria();
